...
\titlespacing*{\section}{0em}{1.4em}{1.4em}
...
\addto{\captionsspanish}{\renewcommand{\contentsname}{Índice general \vspace{1em}}} %babel, toc title format
%use addto to add title to spanish title definitions
%use captionenglish otherwise
\renewcommand{\cfttoctitlefont}{\huge\scshape} %toc title format
...
%\renewcommand{\cftsubsecafterpnum}{\vskip0pt} %vertical spacing between subsections
