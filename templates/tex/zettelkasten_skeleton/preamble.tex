...
% \usepackage[light,math]{kurier} %kurier font
\usepackage{cmbright} %cmbright font
\usepackage[spanish, es-lcroman]{babel}
\usepackage[paperwidth=279mm, paperheight=156.9375mm, left=80mm, right=80mm]{geometry}
...
\setlength\marginparsep{8mm} %separation from text to marginnote
...
\newcommand{\zheader}[4][]{
    ...
    \phantomsection
    {\Large\sffamily #2}
    \marginnote{\footnotesize\sffamily #3}[10mm]
    \addcontentsline{toc}{section}{#4 #2 \textsf{\footnotesize @#3}}
    \marginnote{\hyperref[toc]{\sffamily\Large #4}\label{card:#4}}
    \vspace*{-\topsep}%
    \bigskip
}
\makeatother
